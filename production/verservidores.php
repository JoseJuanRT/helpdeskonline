...
<html lang="es">
  <head>
    ...
    <script>
      ...
      del item sobre el cual se ha clicado, para modificarlo*/
      $(document).ready(function(){
        $("button").click(function(){
          id = $(this).parents("tr").find("td").eq(1).html();
          user = $(this).parents("tr").find("td").eq(6).html();
          url = "modificarservidores.php?ticket="+id+"&user="+user;
          location.href=url;
        });
      });
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-edit"></i> Inventario Servidores</span></a>
                  </li>                                 
                </ul>
              </div>   
            </div>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Inventario de servidores</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table class="table table-striped projects">
                      ...
                      <?php 
                                  ...
                                  /*Almacenamos el correo del usuario registrado*/
                                  $login = $_SESSION['registrado'] -> getEmail();

                                  /*Seleccionamos todos datos de la tabla servidor que estén En Stock*/
                                  $query = $mysqli->query("SELECT * FROM `servidor` ORDER BY `estado` = 'En Stock'");
                                  ...
                                  while($fila = $query->fetch_array(MYSQLI_NUM)){
                                       ...
                                       echo "<tr>";
                                          ...
                                          echo "<td>".$fila[5]."</td>";
                                          echo "<td>".$fila[6]."</td>";
                                          echo '<td><button>Modificar servidor</button></td>';
                                        echo "</tr>";
