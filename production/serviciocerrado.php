          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Solicitudes de servicio cerradas</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table class="table table-striped projects">
                      ...
                      <?php 
                                  ...
                                  /*Buscamos todos los tickets del usuario que estén en estado: cerrados*/
                                  $query = $mysqli->query("SELECT * FROM `ticket` WHERE `usuario_email_solicitante`= '$login' AND `estado`= 'Cerrada' AND `tipo`= 'solicitud' ORDER BY `id` = 0");
