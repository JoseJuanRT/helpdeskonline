...
session_start();
     ...
     /*Si se ha pasado la variable por url*/
     if (isset($_GET['asignarTicket'])){
            ...
            /*Mediante las variables declaradas al principio actualizamos los datos del usuario en la base de datos*/
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="#"><i class="fa fa-edit"></i> Tickets sin asignar</span></a>
                  </li>
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-striped projects">
                      ...
                      <?php 
                                  ...
                                  /*Seleccionamos todos los tickets que estén Abiertos que estén sin asignar*/
