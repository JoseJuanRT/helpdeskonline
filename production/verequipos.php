    ...
    <script>
      ...
      $(document).ready(function(){
        $("button").click(function(){
          ...
          url = "modificarequipos.php?ticket="+id+"&user="+user;
          location.href=url;
        });
      });
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-edit"></i> Inventario Equipos</span></a>
                  </li>
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-striped projects">
                      ...
                      <?php 
                                  ...
                                  $query = $mysqli->query("SELECT * FROM `equipo` ORDER BY `estado` = 'En Stock'");
                                  ...
                                  while($fila = $query->fetch_array(MYSQLI_NUM)){
                                       ...
                                       echo "<tr>";
                                          ...
                                          echo "<td>".$fila[5]."</td>";
                                          echo "<td>".$fila[6]."</td>";
                                          echo '<td><button>Modificar equipo</button></td>';
                                        echo "</tr>";
