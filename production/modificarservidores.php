...
session_start();
     ...
     if (!isset($_GET['ticket'])){
     	...
     	echo "<script language='javascript'> window.location.href='verservidores.php';</script>";
  ...
  <body class="nav-md">
                                    ...
                                    <div class="x_content">
                                      ...
                                      <form method='POST' class="form-horizontal form-label-left">
                                        ...
                                        <div class="item form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="marca" name="marca" class="form-control col-md-7 col-xs-12" value='<?php echo obtenerMarcaServidor($_GET['ticket'])?>'></input>
                                          </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="so" name="so" class="form-control col-md-7 col-xs-12" value='<?php echo obtenerSoServidor($_GET['ticket'])?>'></input>
                                          </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="modelo" name="modelo" class="form-control col-md-7 col-xs-12" value='<?php echo obtenerModeloServidor($_GET['ticket'])?>'></input>
                                          </div>
                                        </div>                                        
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                              ...
                                              <select id="estado" name="estado">
                                                ...
                                                <?php 
                                                  ...
                                                  if (obtenerEstadoServidor($_GET['ticket']) == "En Stock") {
                                        ...
                                        <!-- IP asignada al item actual, con pattern que valida IP -->
                                        <div class="item form-group">
                                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ip">IP <span class="required">*</span>
                                          </label>
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="ip" name="ip" class="form-control col-md-7 col-xs-12" maxlength="16" value='<?php echo obtenerIpServidor($_GET['ticket'])?>' onblur="validar()" required pattern="((^|\.)((25[0-5])|(2[0-4]\d)|(1\d\d)|([1-9]?\d))){4}.(?:\d|[12]\d|3[01])$" title="Debes introducir una IP válida xxx.xxx.xxx.xxx"></input>
                                          </div>
                                        </div>
    ...
    <?php
      ...
      if (isset($_POST['botonS'])){
            ...
            if($query = $mysqli->query("UPDATE `servidor` SET `nombre`='$marca', `so`='$so', `modelo`= '$modelo', `estado`='$estado', `usuarioAsignado`='$usuario', `ip`= '$ip' WHERE `numeroDeSerie` = '$id'")){
