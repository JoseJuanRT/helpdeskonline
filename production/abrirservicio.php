  ...
  <body class="nav-md">
                                  ...
                                  <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                      ...
                                      <form action='' method='POST' class="form-horizontal form-label-left">
                                        ...
                                        <!-- Valor Servicio sin opción a cambio -->
                                        ...
                                        <!-- Título de la solicitud con una restricción de 100 carácteres -->
                                        <div>
                                        ...
                                        <br></br>
                                          ...
                                          <div class="col-md-6 col-md-offset-3">
                                            <!-- Botón de formulario para abrir solicitud-->
    ...
    if (isset($_POST['enviar'])){
         ...
         $fecha = $fecha->format('Y-m-d H:i:s');
            ...
            $mysqli->close();
            /*Se indica al usuario que se ha creado correctamente su solicitud*/
